      ...
      <div className="border-[#25476a] border-[10px] lg:m-[20px] md:m-[20px]">
        ...
        <section className="section">
          ...
          <p className="sectionInfo">
            ...
            {contractFormData?.input1} ( the{" "}
            <span className="font-bold">"Effective Date"</span>).by and Between{" "}
            {contractFormData?.input2} with an address of{" "}
            {contractFormData?.input3} (here in after
            referred to as the <span className="font-bold">"Client"</span>{" "}
            )(colletively referred as the{" "}
          ...
          <p className="sectionTitle">Consideration</p>
          <p className="sectionInfo">
            - A fee of {contractFormData?.input10} will be
            invoice to CLient by the Consultant on the first day of every month
            for all the services provided and performed as will as for all the
            pre-approved expenses incurred the previous month. <br />
            - The Client is required to pay the invoice within{" "}
            {contractFormData?.input11} days upon receiving
            it. <br />
            - The Parties agree that the payments are to be made via{" "}
            {contractFormData?.input12} and sent to the
